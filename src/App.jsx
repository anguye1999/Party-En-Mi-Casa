...
import GameUno from './GameUno.jsx';
import Footer from './Footer.jsx';
import ResultsRoom from './ResultsRoom';
import './App.css';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/room/:code/game-uno" element={<GameUno />} />
        <Route path="/results/:code" element={<ResultsRoom />} />
      </Routes>
    </Router>
  );
}
...
function MainPage() {
  ...
  const handleClick = async (gameChoice) => {
    ...
    // Navigate to the room with the generated code and game choice
    navigate(`/room/${code}?game=${gameChoice}`);
  };
